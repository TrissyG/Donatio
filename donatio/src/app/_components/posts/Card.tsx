...
const Card = ({ post }: CardProps) => {
  ...
  return (
    <div className="relative mx-4 flex items-center justify-center">
      ...
      />
      <div className="absolute top-8 right-4 p-2 bg-black bg-opacity-50 rounded-lg cursor-pointer">
      ...
      <div className="absolute top-8 left-4 p-2 px-4 bg-black bg-opacity-50 text-white rounded-lg">
        <p>{post.causes}</p>
      </div>
      <div
